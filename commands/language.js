...
module.exports = {
  name: "language",
  description: "Он позволяет установить язык бота.",
        ...
        col.on('collect', async (button) => {
          ...
          switch (button.customId) {
            ...
            case 'en':
              ...
              await interaction.editReply({ content: `:white_check_mark: Язык бота успешно изменен на Русский :white_check_mark: `, embeds: [], components: [], ephemeral: true }).catch(e => { })
              await button.deferUpdate().catch(e => { })
              await col.stop()
              break
            case 'nl':
