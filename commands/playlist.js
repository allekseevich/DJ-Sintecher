...
module.exports = {
name: "playlist",
description: "Позволяет управлять командами списка воспроизведения.",
options: [
{
name: "create",
description: "Создайте список воспроизведения.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
description: "Напишите название плейлиста, который хотите создать.",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "public",
description: "Сделать плейлист общедоступным. (true=общедоступный плейлист, false=приватный плейлист)",
...
{
name: "name",
description: "Напишите название плейлиста, который хотите удалить.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "add-music",
description: "Позволяет добавлять песни в плейлист.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "playlist-name",
description: "Напишите название плейлиста.",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "name",
description: "Напишите название музыки или ссылку на песню.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "delete-music",
description: "Позволяет удалять музыку из плейлиста.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "playlist-name",
...
{
name: "name",
description: "Напишите название песни.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "lists",
description: "Просмотрите все свои плейлисты.",
type: ApplicationCommandOptionType.Subcommand,
options: []
},
{
name: "top",
description: "Самые популярные плейлисты.",
type: ApplicationCommandOptionType.Subcommand,
options: []
}
